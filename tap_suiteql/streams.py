...
class AccountTypeStream(suiteqlStream):
    ...
    schema = th.PropertiesList(
        th.Property("balancesheet", th.StringType),
        ...
        th.Property("includeinrevaldefault", th.StringType),
        ...
        th.Property("usercanchangerevaloption", th.StringType),
    ).to_dict()
...
class CustomerStream(suiteqlStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("id", th.IntegerType),
        th.Property("isautogeneratedrepresentingentity", th.StringType),
...
class SubsidiaryStream(suiteqlStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("custrecord_pt_sub_taxonomy_reference", th.IntegerType),
        ...
        th.Property("representingcustomer", th.IntegerType),
        th.Property("representingvendor", th.IntegerType),
        th.Property("returnaddress", th.IntegerType),
        th.Property("shippingaddress", th.IntegerType),
...
class VendorCategoryStream(suiteqlStream):
    ...
    schema = th.PropertiesList(
        th.Property("isinactive", th.StringType),
        th.Property("externalid", th.StringType),
        th.Property("istaxagency", th.StringType),
        th.Property("id", th.StringType),
        th.Property("lastmodifieddate", th.DateTimeType),
        th.Property("name", th.StringType),
    ).to_dict()
